  ...
  return (
    <main className="halo">
      ...
      <section className="text-center mt-16">
        <h1 className="leading-tight">Cross‑border remittance, <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-blue-400">as smooth as Stripe</span></h1>
        <p className="max-w-2xl mx-auto text-zinc-400 mt-4">
      ...
      <section className="grid md:grid-cols-3 gap-4 mt-16">
        {[
          ...
          <div key={t} className="card">
            <h2>{t}</h2>
            <p className="text-zinc-400 mt-2">{d}</p>
          </div>
        ))}
      </section>
      <section className="card mt-12">
        <h2 className="text-center">MVP Scope</h2>
        <ul className="list-disc text-zinc-300 mt-3 ml-6">
