    ...
    <main className="halo bg-grid">
      ...
      <section className="text-center mt-14">
        ...
        <p className="max-w-2xl mx-auto text-zinc-600 dark:text-zinc-400 mt-4">
          Move money between the US and India using compliant stablecoins. 
          Account-abstraction UX—no gas nags. Permissioned flows with jurisdiction rules and rigorous KYC/AML.
        </p>

        {/* SAFE LINKS (build won’t fail) */}
      ...
      <section className="mt-16">
        ...
        <div className="grid md:grid-cols-4 gap-4 mt-6">
          {[
            ...
            ['4. Send','Enter recipient mobile or contact. They get SMS/WhatsApp.']
          ].map(([t,d])=>(
      ...
      <section className="card mt-12">
        <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-mint to-sunset">
          Safety & Limits
        </h2>
        <ul className="list-disc ml-5 mt-3 text-zinc-700 dark:text-zinc-300 space-y-1">
          <li>First transfer limited to <b>$5</b>; then up to <b>$10,000/day</b>.</li>
          <li>Transactions are irreversible—numbers are validated.</li>
          <li>Privacy-first; masking roadmap via TEEs/MPC/zkTLS.</li>
        </ul>
      </section>
      ...
      <section className="grid md:grid-cols-3 gap-4 mt-12">
        <div className="card">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-2">
            US→IN corridor, stablecoin rails, KYC-gated wallet.
          </p>
        </div>
        <div className="card">
          <h3 className="font-semibold">Phase 2 · Cards</h3>
          <p className="text-zinc-600 dark:text-zinc-400 mt-2">
            Virtual/physical cards for merchant payments.
          </p>
        </div>
        <div className="card">
          <h3 className="font-semibold">Phase 3 · Yield & More</h3>
          <p className="text-zinc-600 dark:text-zinc-400 mt-2">
            Capital-protected yield instruments & savings.
          </p>
        </div>
      </section>
      ...
      <section className="text-center my-14">
        <Link href="#" className="btn-primary">Launch the demo</Link>
      </section>
